...
const getTokenAccounts = async (connection: Connection, address: PublicKey) => {
...
export const useGetTokenAccounts = ({ address }: { address: PublicKey }) => {
  ...
  return useQuery({
    ...
    queryFn: () => getTokenAccounts(connection, address),
  });
};
...
const transferSol = async (
  ...
  try {
    ...
    console.error(error, "error transferring sol");
    return null;
  }
};
...
export const useTransferSol = ({ address }: { address: PublicKey }) => {
  ...
  return useMutation({
    ...
    mutationFn: async ({ amount, destination }: TransferSolParams) =>
      transferSol(connection, address, destination, amount, wallet),
    onSuccess: (signature) => {
      if (signature) {
